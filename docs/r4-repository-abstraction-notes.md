...
作成日: 2026-07-11
更新日: 2026-07-11（第7章ステップ6に計算プロパティ削除前チェック条件を追記）
ステータス: 設計承認済み・実装待ち（本書と第7章のステップ分解は2026-07-11にオーナー承認済み。着手はR3=v1.5.0の本番浸透確認後で、着手指示を別途待つこと。着手時に本書とコードを突き合わせ、ズレがあれば本書を更新すること）
関連文書:

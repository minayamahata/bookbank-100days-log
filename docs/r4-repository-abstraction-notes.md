...
### 10.1 共有IDのuuid化は R4.5 に含める（✅ オーナー確定・2026-08-07）
...
- **共有IDのuuid化** ✅ 実施決定（10.1・2026-08-07）

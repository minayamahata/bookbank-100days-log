...
作成日: 2026-07-07
更新日: 2026-07-09（R2完了・v1.4.0リリース反映）
...
1. **R3（v1.5.0）の着手**: 移行 Phase 0（UUID導入）。`docs/cloud-migration-architecture.md` を読み、タスク分解→承認→実装
2. **R1 残件の優先度判断**: D-4 / F-1 / F-2 / C-4 / A-9 / B-5 — R3 と並行可能なものは v1.4.x パッチとして回収（下記「R1 残件」参照）

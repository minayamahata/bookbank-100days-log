...
| G-1 / G-2 / G-3 / G-5 | ついでに検索系の軽微修正: Googleタイムスタンプ形式の発売日パース、`SalesDateParser` のタイムゾーン固定（JST基準）、`%lld` 統一、`displayProviderName` のローカライズ。**（G-3・G-5はステップ3で完了 (2026-07-08)。G-1・G-2はステップ6で完了 (2026-07-08)）** |
